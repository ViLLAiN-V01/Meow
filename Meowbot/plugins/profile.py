...
@bot.on(mew_cmd(pattern="offline$", outgoing=True)) 
async def _(event):
    if event.fwd_from:
        return
    user_it = "me"
...
@bot.on(mew_cmd(pattern="online$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    user_it = "me"
...
@bot.on(mew_cmd(outgoing=True, pattern="username (.*)"))
...
@bot.on(mew_cmd(outgoing=True, pattern="count$"))
...
@bot.on(mew_cmd(outgoing=True, pattern=r"delpfp"))
...
@bot.on(mew_cmd(pattern="myusernames$"))
async def _(event):
    if event.fwd_from:
        return
