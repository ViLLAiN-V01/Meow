...
@bot.on(mew_cmd(pattern="sfrog (.*)"))
@bot.on(sudo_cmd(pattern="sfrog (.*)", allow_sudo=True))
async def mew(frogsay):
    if frogsay.fwd_from:
        return
...
@bot.on(mew_cmd(pattern="sdead (.*)"))
@bot.on(sudo_cmd(pattern="sdead (.*)", allow_sudo=True))
async def mew(deadfrog):
...
@bot.on(mew_cmd(pattern="strump (.*)"))
@bot.on(sudo_cmd(pattern="strump (.*)", allow_sudo=True))
async def mew(trumpsay):
...
@bot.on(mew_cmd(pattern=r"sshit$"))
...
@bot.on(mew_cmd(pattern=r"elove$"))
...
@bot.on(mew_cmd(pattern=r"monster$"))
...
@bot.on(mew_cmd(pattern=r"hello$"))
...
@bot.on(mew_cmd(pattern=r"couple$"))
...
@bot.on(mew_cmd(pattern=r"india$"))
...
@bot.on(mew_cmd(pattern=r"shitos$"))
...
@bot.on(mew_cmd(pattern=r"dislike$"))
