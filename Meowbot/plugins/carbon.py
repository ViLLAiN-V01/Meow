...
@bot.on(mew_cmd(outgoing=True, pattern="carbon(?: |$)(.*)"))
...
async def carbon_api(e):
    ...
    Meow = await edit_or_reply(e, "`Carbonizing...\n25%`")
    ...
    await Meow.edit("`Processing..\n75%`")
    # Waiting for downloading
    await asyncio.sleep(2)
    await Meow.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await Meow.edit("`Uploading..`")
    await e.client.send_file(
        e.chat_id,
        file,
        caption="Here's your carbon, \n Carbonised by ℳêøաɮøƚ",
        force_document=True,
...
@bot.on(mew_cmd(outgoing=True, pattern="krb"))
@bot.on(sudo_cmd(pattern="krb", allow_sudo=True))
async def carbon_api(e):
    if e.fwd_from:
        return
    Meow = await edit_or_reply(e, "`Processing....`")
    CARBON = "https://carbon.now.sh/?l={lang}&code={code}"
    textx = await e.get_reply_message()
    pcode = e.text
    if pcode[5:]:
...
async def carbon_api(e):
    ...
    await Meow.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await Meow.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
        force_document=True,
...
async def carbon_api(e):
    ...
    await Meow.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await Meow.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await Meow.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await Meow.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await Meow.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await Meow.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await Meow.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await Meow.edit("✅RGB Karbon 2.0 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await Meow.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await Meow.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
        caption=f"Here's your karbonrgb",
