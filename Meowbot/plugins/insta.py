...
async def _(event):
    ...
    if "www.instagram.com" not in input_str:
        ...
        mew = await eor(event, "Trying to download.... please wait!")
    async with event.client.conversation(bot) as conv:
        try:
            ...
            await mew.edit("User Blocked!! Please Unblock @instasavegrambot and try again...")
            return
        await mew.delete()
        ...
        await final.edit(
            f"📥 InstaGram Video Downloaded By :- {mew_mention}")
