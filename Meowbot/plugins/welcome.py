...
from Meowbot.sql.welcome_sql import get_current_welcome, add_welcome, rm_welcome, update_welcome
from . import *
...
@bot.on(mew_cmd(pattern="savewelcome(?: |$)(.*)"))
...
@bot.on(mew_cmd(pattern="cleanwelcome$"))
...
@bot.on(mew_cmd(pattern="showwelcome$"))
...
@bot.on(mew_cmd(pattern="welcome_note$"))
