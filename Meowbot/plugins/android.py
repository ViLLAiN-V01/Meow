...
@bot.on(mew_cmd(pattern=r"magisk"))
...
@bot.on(mew_cmd(outgoing=True, pattern=r"device(?: |$)(\S*)"))
...
@bot.on(mew_cmd(outgoing=True, pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@bot.on(mew_cmd(outgoing=True, pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@bot.on(mew_cmd(outgoing=True, pattern=r"twrp(?: |$)(\S*)"))
