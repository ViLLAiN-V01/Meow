...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        if os.path.exists(downloaded_file_name):
            await Meow.edit("Downloaded to `{}` in {} seconds.".format(downloaded_file_name, ms)
            )
        else:
...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        if os.path.exists(downloaded_file_name):
            ...
            await Meow.edit("Downloaded in {} seconds. Uploaded in {} seconds.".format(
                    ms_one, ms_two
                )
            )
        else:
        ...
        await Meow.edit("Syntax // `{}rnupload file.name` as reply to a Telegram media".format(hl))
