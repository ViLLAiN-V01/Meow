...
@bot.on(mew_cmd(pattern=r"boxs$", outgoing=True))
...
@bot.on(mew_cmd(pattern=r"rain$", outgoing=True))
...
@bot.on(mew_cmd(pattern=r"deploy$", outgoing=True))
...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest [Github Build](TeamMew/MeowBot)**",
        f"**Build started by user** {mew_mention}",
        f"**Deploy** `535a74f0` **by user** **{mew_mention}**",
        ...
        "__INFO:ℳêøաɮøƚ:Logged in as 557667062__",
        "__INFO:ℳêøաɮøƚ:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
...
@bot.on(mew_cmd(pattern=r"dump$", outgoing=True))
...
@bot.on(mew_cmd(pattern=r"fleaveme$", outgoing=True))
...
@bot.on(mew_cmd(pattern=r"loveu$", outgoing=True))
...
@bot.on(mew_cmd(pattern=r"plane$", outgoing=True))
...
@bot.on(mew_cmd(pattern=r"police$", outgoing=True))
...
@bot.on(mew_cmd(pattern=r"jio$", outgoing=True))
...
@bot.on(mew_cmd(pattern=r"solarsystem$", outgoing=True))
...
@bot.on(mew_cmd(pattern=r"lmoon", outgoing=True))
...
@bot.on(mew_cmd(pattern=r"city", outgoing=True))
...
@bot.on(mew_cmd(pattern=r"hii", outgoing=True))
...
@bot.on(mew_cmd(pattern=r"cheer", outgoing=True))
...
@bot.on(mew_cmd(pattern=r"getwell", outgoing=True))
...
async def _(event):
  ...
  #  if input_str == "switch":
    ...
    animation_chars = [
         "⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜[🔲](https://github.com/TeamMew/MeowBot)\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜",
...
@bot.on(mew_cmd(pattern=r"sprinkle", outgoing=True))
...
@bot.on(mew_cmd(pattern=r"f", outgoing=True))
...
@bot.on(mew_cmd(outgoing=True, pattern="kiler( (.*)|$)"))
...
async def _(event):
    ...
    event = await eor(event, f"**Ready Commando **__{mew_mention}....")
    animation_chars = [
        "Ｆｉｉｉｉｉｒｅ",
        f"__**Commando **__{mew_mention}          \n\n_/﹋\_\n (҂`_´)\n <,︻╦╤─ ҉ - \n _/﹋\_\n",
        f"__**Commando **__{mew_mention}          \n\n_/﹋\_\n (҂`_´)\n  <,︻╦╤─ ҉ - -\n _/﹋\_\n",
        f"__**Commando **__{mew_mention}          \n\n_/﹋\_\n (҂`_´)\n <,︻╦╤─ ҉ - - -\n _/﹋\_\n",
        f"__**Commando **__{mew_mention}          \n\n_/﹋\_\n (҂`_´)\n<,︻╦╤─ ҉ - -\n _/﹋\_\n",
        f"__**Commando **__{mew_mention}          \n\n_/﹋\_\n (҂`_´)\n <,︻╦╤─ ҉ - \n _/﹋\_\n",
...
@bot.on(mew_cmd(pattern="thinking$"))
...
@bot.on(mew_cmd(pattern=r"repe$", outgoing=True))
