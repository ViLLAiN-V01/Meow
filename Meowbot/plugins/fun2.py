...
@bot.on(mew_cmd(pattern="pat ?(.*)", outgoing=True))
...
@bot.on(mew_cmd(pattern="join$", outgoing=True))
...
@bot.on(mew_cmd(pattern="pay$", outgoing=True))
...
@bot.on(mew_cmd(pattern="climb$", outgoing=True))
...
@bot.on(mew_cmd(pattern="aag$", outgoing=True))
...
@bot.on(mew_cmd(pattern="push$", outgoing=True))
...
@bot.on(mew_cmd(pattern="work$", outgoing=True))
...
@bot.on(mew_cmd(pattern="suckit$", outgoing=True))
...
@bot.on(mew_cmd(pattern="ohh$", outgoing=True))
...
@bot.on(mew_cmd(pattern="lovestory$", outgoing=True))
...
@bot.on(mew_cmd(pattern="bf$", outgoing=True))
...
@bot.on(mew_cmd(pattern="session$", outgoing=True))
