...
@bot.on(mew_cmd(pattern=r"fry(?: |$)(.*)", outgoing=True))
...
async def deepfry(img: Image) -> Image:
    ...
    # Overlay red and yellow onto main image and sharpen the Meow out of it
